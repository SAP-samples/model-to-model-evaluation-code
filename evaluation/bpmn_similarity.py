...
def calculate_similarity_scores(
    ...
    # tasks
    task_names_sim, task_names_n_union = similarity_SFA(
        task_names1, task_names2, method=method, threshold=similarity_threshold
    )
    task_types_sim, task_types_n_union = similarity_SFA(
        task_types1, task_types2, method=method, threshold=similarity_threshold
    )
    ...
    # events
    event_names_sim, event_names_n_union = similarity_SFA(
        event_names1, event_names2, method=method, threshold=similarity_threshold
    )
    event_types_sim, event_types_n_union = similarity_SFA(
        event_types1, event_types2, method=method, threshold=similarity_threshold
    )
    ...
    # gateways
    gateway_names_sim, gateway_names_n_union = similarity_SFA(
        gateway_names1, gateway_names2, method=method, threshold=similarity_threshold
    )
    gateway_types_sim, gateway_types_n_union = similarity_SFA(
        gateway_types1, gateway_types2, method=method, threshold=similarity_threshold
    )
    ...
    sequence_flows_sim, sequence_flows_n_union = similarity_SFA(
        seq_flows_str1, seq_flows_str2, method=method, threshold=similarity_threshold
    )
    message_flows_sim, message_flows_n_union = similarity_SFA(
        mes_flows_str1, mes_flows_str2, method=method, threshold=similarity_threshold
    )
    ...
    # lanes
    lanes_without_refs_sim, lanes_without_refs_n_union = similarity_SFA(
        lanes1, lanes2, method=method, threshold=similarity_threshold
    )
    lanes_with_refs_sim, lanes_with_refs_n_union = similarity_SFA(
        lanes_with_refs1, lanes_with_refs2, method=method, threshold=similarity_threshold
    )
